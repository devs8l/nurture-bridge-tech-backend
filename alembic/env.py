...
# Import all model modules (not individual classes) so Alembic can detect them
import db.models.auth
import db.models.clinical
import db.models.assessment
import db.models.report
...
def get_url():
    ...
    # Convert ssl parameter to sslmode for psycopg2
    if 'ssl' in query_params:
        # Remove ssl parameter

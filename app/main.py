...
# AI Service - initialized in lifespan, accessed via dependency injection
...
app = FastAPI(
    ...
    version="1.0.0",
    description="InQuantic.ai - Nurture Bridge Backend Service",
...
def get_gemini_service() -> GeminiService:
    ...
    Use this in your endpoints like:
    
    from fastapi import Depends
    from app.main import get_gemini_service
    
    @router.get("/endpoint")
    async def endpoint(ai_service: GeminiService = Depends(get_gemini_service)):
